    ...
    <div class="container">
        ...
        <div class="row">
            <div class="section-header text-center">
                <h2>Why Energy WebSite</h2>
                <p class="lead">Energy is essential to life and all living organisms. The sun, directly or indirectly, is the source of all the energy available on Earth. Our energy choices and decisions impact Earth's natural systems in ways we may not be aware of, so it is essential that we choose our energy sources carefully.</p>
            </div>
